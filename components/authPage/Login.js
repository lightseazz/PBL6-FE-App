...
export default function Login({ navigation }){
    return(
        <View style={layout.container}> 
            ...
            />
            <View style = {{width: '80%'}}>
                <TextInput label='username' mode='outlined' style={{marginBottom: 30}}/> 
                <TextInput  label='password' mode='outlined' style={{marginBottom: 10}}/> 
                <Button onPress={(() => navigation.navigate('ChangePass'))} style={{alignSelf: 'flex-end'}}>Forgot your password</Button>
            </View>
            <Button onPress={(() => navigation.navigate('BottomTab'))} mode="elevated" style={{marginTop: 10}}>Login</Button>
